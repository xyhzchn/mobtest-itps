...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="mob.com" class="logo">
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>yoozoo-</b>ITS</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<%=request.getContextPath()%>/jsp/login.jsp" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
